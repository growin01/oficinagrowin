...
public function ajaxdescuentoUsuario(){

	$tabla = "usuarios_empresas";
	$Estado = "Descuento";
	$id = "id";

	$activarUsuario = $this->descuentoUsuario;
	$valorid = $this->descuentoId;
...
if(isset($_POST["descuentoUsuario"])){ 
	
	$descuentoUsuario = new AjaxUsuarios();
	$descuentoUsuario -> descuentoUsuario = $_POST["descuentoUsuario"];
	$descuentoUsuario -> descuentoId = $_POST["descuentoId"];
	$descuentoUsuario -> ajaxdescuentoUsuario();
