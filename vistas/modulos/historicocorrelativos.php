  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       <h1 class="col-xs-12 pull-left" style="font-size: 30px"><i class="fa fa-user fa-lg" style="padding-left:50px"></i>Historico de Correlativos Autorizados
      </h1>
        ...
        <div class="box-body">
          ...
          <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
            ...
            <tbody>
              ...
              $Correlativos = ControladorCorrelativos::ctrMostrarhistoricosCorrelativos($taRncEmpresa, $RncEmpresa, $orden);
