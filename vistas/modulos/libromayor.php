...
<button class="btn btn-warning" data-toggle="modal" data-target="#modalleyendacorrelativos"><i class="fa fa-list" style="padding-right:5px"></i>Leyenda de Correlativos
 ...
 <table border="0" cellspacing="4" cellpadding="4">
              ...
              <tbody>
                <tr>
                       <td>Período &nbsp;</td>
                    <td><select class="form-control pull-left col-xs-3" name="periodolibromayor" id="periodolibromayor">
  <?php 
 ...
 echo'<option value="'.$_SESSION["Anologin"].'">'.$_SESSION["Anologin"].'</option>';
  foreach ($_SESSION["Perido"] as $key => $value) {
   ...
   ?>
                ...
                <tr>
                    <td>Desde &nbsp;</td>
                    <td><input type="text" maxlength="6" id="minlibromayor" name="minlibromayor" placeholder="AñoMes"></td>
                   
                    <td><input type="text" class="col-xs-3" maxlength="2" id="mindialibromayor" name="mindialibromayor" placeholder="Día"></td>
                </tr>

                <tr>
                    <td>Hasta &nbsp;</td>
                    <td><input type="text" maxlength="6" id="maxlibromayor" name="maxlibromayor" placeholder="AñoMes"></td>
                   
                    <td><input type="text" class="col-xs-3" maxlength="2" id="maxdialibromayor" name="maxdialibromayor" placeholder="Día"></td>
              </tr>
  ...
  <input type="hidden" class="form-control" id="Proyecto" name="Proyecto" value="<?php echo $_SESSION["Proyecto"]?>">
          ...
          <table class="table table-bordered table-striped libromayor"  width="100%">
