                  ...
                  <div class="form-group col-xs-6">
                    ...
                    <div class="input-group">
                     ...
                     <div class="input-group form-control TipoClienteFactura">
                      ...
                      <?php 
                      if ($cliente == false){
                        echo '  <input type="radio" Class="JuridicoClienteFactura" id="JuridicoClienteFactura" name="Tipo_Cliente_Factura"  value="1" required> Jurídico
                        ...
                        echo '<input type="radio" Class="JuridicoClienteFactura" id="JuridicoClienteFactura" name="Tipo_Cliente_Factura"  value="1" required checked> Jurídico
    ...
    <input type="radio" Class="FisicoClienteFactura" id="FisicoClienteFactura" name="Tipo_Cliente_Factura" value="2" required checked> Fisico';
        ...
        <div class="form-group col-xs-6">
            ...
            <div class="input-group">
              ...
              <input type="text" maxlength="11" class="form-control" id="RncClienteFactura" name="RncClienteFactura" placeholder="Ingresar Documento" value="<?php echo $clienteDocumento?>"required>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" maxlength="11" id="Nombre_Cliente" name="Nombre_Cliente" placeholder="Nombre Cliente" value="<?php echo $clienteNombre?>" required>
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="nuevoTelefono" name="nuevoTelefono" placeholder="Ingresar Teléfono" value="<?php echo  $clienteTelefono?>"required>
          ...
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <input type="email" class="form-control" id="nuevoEmail" name="nuevoEmail" placeholder="Ingresar email" value="<?php echo  $clienteEmail?>" required>
          ...
          <!--*****************cierra input de EMAIL************************* -->
           ...
           <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
              <input type="text" class="form-control"  maxlength="400" id="Observaciones" name="Observaciones" placeholder=" Obrservaciones de Factura">
