              ...
              ?>
                ...
                <div class="box">
                  ...
                  <input type="hidden"  id="RncEmpresa607" name="Editar-RncEmpresa607" value="<?php echo $_SESSION["RncEmpresaUsuario"];?>">
                   ...
                   <input type="hidden" class="form-control" id="Editar_id_Ajuste" name="Editar_id_Ajuste" value="<?php echo $_GET["id_Ajuste"]?>">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control input-RNC" maxlength="11" id="Editar-Rnc_Factura" name="Editar-Rnc_Factura" value="<?php echo $Rnc_Factura;?>" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                     ...
                     <label>Año/Mes</label>
                      <input type="text" class="Fechames_607" maxlength="6" id="Editar-FechaFacturames_607" name="Editar-FechaFacturames_607" value="<?php echo $value["Fecha_AnoMes_LD"];?>" required autofocus>

                     
                      <label>Dìa</label>
                      <input type="text" class="Fechadia_607" maxlength="2" id="Editar-FechaFacturadia_607" name="Editar-FechaFacturadia_607" value="<?php echo $value["Fecha_dia_LD"];?>" required>
                  ...
                  <!--=================================================
                   ...
                   <!--=================================================-->
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="Editar-Descripcion" name="Editar-Descripcion" value="<?php echo $value["ObservacionesLD"];?>">
...
if($_SESSION["Proyecto"] == 1){ 
          ...
          $Editarajustediario = new ControladorDiario();
          $Editarajustediario -> ctrEditarajustediario(); 
