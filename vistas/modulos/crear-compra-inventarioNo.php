...
<div class="col-xs-3" style="padding-right:0px">
    ...
    <div class="input-group">
        ...
        <?php 
          if(isset($_SESSION["NCFCompraNo"])){
                                      
          echo'<select class="form-control"  id="NCFCompraNo" name="NCFCompraNo" required>
...
echo'<select class="form-control"  id="NCFCompraNo" name="NCFCompraNo" required>
 ...
 ?>
                  ...
                  <input type="hidden" class="form-control input-NCF" id="CodigoNCFCompra" name="CodigoNCFCompra" maxlength="13" placeholder="Ingrese NCF" value="<?php if (isset($_SESSION['CodigoNCFCompra'])){ echo $_SESSION['CodigoNCFCompra']; } ?>" required>
...
?> 
           ...
           <?php 
            ...
            $comprasinventario -> ctrcomprasinventarioNo();
