  ...
  <input type="hidden"  id="RncEmpresaProductos" value="<?php echo $_SESSION["RncEmpresaUsuario"];?>">
   ...
   <table border="0" cellspacing="4" cellpadding="4">
              ...
              <tbody>
                <tr>
                       <td>Período &nbsp;</td>
                    <td><select class="form-control pull-left col-xs-3" name="periodolibroinventario" id="periodolibroinventario">
  <?php 
if(isset($_GET["periodolibroinventario"])){
echo'<option value="'.$_GET["periodolibroinventario"].'">'.$_GET["periodolibroinventario"].'</option>';
  foreach ($_SESSION["Perido"] as $key => $value) {
    if($_GET["periodolibroinventario"] != $value) { 
 ...
 echo'<option value="'.$_SESSION["Anologin"].'">'.$_SESSION["Anologin"].'</option>';
  foreach ($_SESSION["Perido"] as $key => $value) {
   ...
   ?>
                ...
                <tr>
                    <td>Desde &nbsp;</td>
                    <td><input type="text" maxlength="6" id="minlibroinventario" name="minlibroinventario" placeholder="AñoMes"></td>
                   
                    <td><input type="text" class="col-xs-3" maxlength="2" id="mindialibroinventario" name="mindialibroinventario" placeholder="Día"></td>
                </tr>

                <tr>
                    <td>Hasta &nbsp;</td>
                    <td><input type="text" maxlength="6" id="maxlibroinventario" name="maxlibroinventario" placeholder="AñoMes"></td>
                   
                    <td><input type="text" class="col-xs-3" maxlength="2" id="maxdialibroinventario" name="maxdialibroinventario" placeholder="Día"></td>
              </tr>
...
<div class="col-xs-4">
    ...
    <input type="text" class="form-control" value="<?php echo $inputTotalventas;?>" readonly>
          ...
          <table class="table table-bordered table-striped dt-responsive librodeinventario"  width="100%">
        ...
        $librodeinventario = ControladorProductos::ctrMostrarlibrodeinventario($Rnc_Empresa_Productos); 

      $Totalcosto = 0;
      $Totalventa = 0;
      $ganancia = 0;

        foreach ($librodeinventario as $key => $value) {
          $imagen = "<img src='".$value["Imagen"]."' width='200px'>";

          $id = "id";
        $id_categorias = $value["id_categorias"];
      ...
      $Totalcosto = $value["Stock"] * $value["Precio_Compra"];
      $Totalventa = $value["Stock"] * $value["Precio_Venta"];
