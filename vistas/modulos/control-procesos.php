      ...
      <div class="box">
        ...
        <div class="box-header with-border">
          ...
          <button  class="btn btn-primary">Agregar Empresa
            ...
            <select class="btn btn-default pull-right"  id="FechaControl" name="FechaControl">
              ...
              <select class="btn btn-default pull-right"  id="NombreEmpresaControl" name="NombreEmpresaControl">
        ...
        <div class="box-body">
          ...
          <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
            ...
            <tbody>
               ...
               if(isset($_GET["Fechacontrol"])){
                  $Rnc_Empresa_Master = $_SESSION["RncEmpresaUsuario"];
                  $Periodo_Empresa = $_GET["Fechacontrol"];
                  $Rnc_Empresa = null;
                  
                }elseif(isset($_GET["NombreControl"])){
                  $Rnc_Empresa_Master = $_SESSION["RncEmpresaUsuario"];
                  $Periodo_Empresa = null;
                  $Rnc_Empresa = $_GET["NombreControl"];
                ...
                $respuesta = ControladorEmpresas::ctrControlEmpresas($Rnc_Empresa_Master, $Periodo_Empresa, $Rnc_Empresa);
                        ...
                        foreach ($respuesta as $key => $value){
                          ...
                          if($value["606_Empresa"] <> 0 || $value["607_Empresa"] <> 0 || $value["ITBIS_Empresa"] <> 0){
                            $numeroEmpresa = $numeroEmpresa + 1;
          ...
          <div class="form-group col-xs-4">
            ...
            <label class="form-control">Numero de Empresas Con Información</label>
            

            <input type="text"  class="form-control" value="<?php echo $numeroEmpresa?>" readonly>
