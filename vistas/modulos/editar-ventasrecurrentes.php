          ...
          <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="box">
                  ...
                  $venta = ControladorVentas::ctrMostrarVentaRecurrenteEditar($id, $valoridVenta);
...
<input type="hidden" class="form-control" id="NAsiento" name="NAsiento" value="<?php echo $NAsiento;?>" required> 
...
<div style="padding-right: 0px"  class="form-group col-xs-4">
  ...
  <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
       ...
       <input type="text" class="form-control" maxlength="6" id="FechaFacturames" name="FechaFacturames" value="<?php echo $venta["FechaAnoMes"]?>" placeholder="Año/Mes Ejemplo 202001" required>    
...
<div style="padding-left: 0px" class="form-group col-xs-4">
  ...
  <div class="input-group">
 <input type="text" class="form-control" maxlength="2" id="FechaFacturadia" name="FechaFacturadia"  value="<?php echo $venta["FechaDia"]?>" placeholder="Día Ejemplo 01" required autofocus>
 </div>  
...
<div class="col-xs-6 pull-left" style="padding-right:0px">
...
<?php 
$extraerNCF = $venta["EXTRAER_NCF"];
switch ($extraerNCF) {
  case 'FP1':
    echo ' <option value="FP1">FP1</option>
    ...
    break;
   case 'E31':
    echo '  <option value="E31">E31</option>
            <option value="FP1">FP1</option>
            <option value="B01">B01</option>
            <option value="B02">B02</option>
            <option value="E32">E32</option>
    ...
    break;
     case 'E32':
    echo '  <option value="E32">E32</option>
            <option value="FP1">FP1</option>
            <option value="B01">B01</option>
            <option value="E31">E31</option>
            <option value="B02">B02</option>
    ...
    break;
    case 'E33':
    echo '  <option value="E33">E33</option>
            <option value="FP1">FP1</option>
            <option value="B01">B01</option>
            <option value="E31">E31</option>
            <option value="B02">B02</option>
    ...
    break;
   case 'E41':
    echo '  <option value="E41">E41</option>
            <option value="FP1">FP1</option>
            <option value="B01">B01</option>
            <option value="E31">E31</option>
            <option value="B02">B02</option>
    ...
    break;
    case 'E42':
    echo '  <option value="E42">E42</option>
            <option value="FP1">FP1</option>
            <option value="B01">B01</option>
            <option value="E31">E31</option>
            <option value="B02">B02</option>
  ...
  case 'E44':
    echo '  <option value="E44">E44</option>
            <option value="FP1">FP1</option>
            <option value="B01">B01</option>
            <option value="E31">E31</option>
            <option value="B02">B02</option>
   ...
   case 'E45':
    echo '  <option value="E45">E45</option>
            <option value="FP1">FP1</option>
            <option value="B01">B01</option>
            <option value="E31">E31</option>
            <option value="B02">B02</option>
...
<!--=================== ENTRADA DEL VENDEDOR =======================================================-->
 ...
 <input type="hidden" class="form-control" id="idVentaRecurrente" name="idVentaRecurrente" value="<?php echo $venta["id"]?>" readonly>
...
<!--===============================ENTRADA DEL CODIGO DE LA VENTA===========================-->
          ...
          <!--*****************cierra input de EMAIL************************* -->
           ...
           <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
              <input type="text" class="form-control input-xs" maxlength="150" id="Observaciones" name="Observaciones" value="<?php echo $venta["Observaciones"]?>">
...
<input type="hidden" name="VentaRecurrente" id="VentaRecurrente" value="1" required>
...
<button type="submit" class="btn btn-warning pull-right">Modificar</button>
          ...
          <?php 
            ...
            $editarVenta -> ctrEditarVentaRecurrentes();
