  ...
  <a href="reporte-607" class="btn btn-success"><i class="fa fa-server" style="padding-right:5px"></i>Reporte 607</a>
   ...
   <button class="btn btn-success" data-toggle="modal" data-target="#modalDescarga607"><i class="fa fa-file-text-o" style="padding-right:5px"></i>Descarga de TXT 607</button>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Editar Registro 607</li>
      </ol>
    </section>
...
<div style="padding-right: 0px"  class="form-group col-lg-6">
  ...
  <div class="input-group">
    ...
    <input type="text" class="form-control Fechames_607" maxlength="6" id="FechaFacturames_607" name="FechaFacturames_607" value="<?php echo $EditarRegistro607["Fecha_comprobante_AnoMes_607"];?>" placeholder="Año/Mes Ejemplo 202001" required>
...
<div style="padding-left: 0px" class="form-group col-lg-6">
  ...
  <div class="input-group">
     ...
     <input type="text" class="form-control Fechadia_607" maxlength="2" id="FechaFacturadia_607" name="FechaFacturadia_607" value="<?php echo $EditarRegistro607["Fecha_Comprobante_Dia_607"];?>" placeholder="Día Ejemplo 01" required autofocus>
...
<div class="col-xs-3" style="padding-right:0px">
  ...
  <span class="input-group-addon"><i class="fa fa-key"></i></span>
      ...
      <?php  
$NCF607 = $EditarRegistro607["EXTRAER_NCF_607"];
...
<?php  
$numero = substr($EditarRegistro607["NCF_607"], 3);
...
<input type="text" maxlength="10" class="form-control input-NCF-607" id="CodigoNCF607" name="CodigoNCF607" value="<?php echo $numero;?>" required>
...
<input type="text" class="form-control input-NCFMOD" maxlength="13" id="NCF_Modificado_607" name="NCF_Modificado_607" placeholder="NCF Afectado" value="<?php if (isset($_SESSION['NCF_Modificado_607'])){ echo $_SESSION['NCF_Modificado_607']; } ?>">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" min=0 step="any" id="Monto_Facturado_607" name="Monto_Facturado_607" value="<?php echo $EditarRegistro607["Monto_Facturado_607"];?>" required>
   ...
   <input class="form-control" type="text"  min=0 step="any" id="ITBIS_Facturado_607" name="ITBIS_Facturado_607" value="<?php echo $EditarRegistro607["ITBIS_Facturado_607"];?>" required>
  ...
  <input type="text" class="form-control" min=0 step="any" id="Monto_Propina_Legal_607" name="Monto_Propina_Legal_607" value="<?php echo $EditarRegistro607["Monto_Propina_Legal_607"];?>" required>
...
<input type="text" class="form-control" min=0 step="any" id="Impuesto_Selectivo_al_Consumo_607" name="Impuesto_Selectivo_al_Consumo_607" value="<?php echo $EditarRegistro607["Impuesto_Selectivo_al_Consumo_607"];?>" required>
  ...
  <input type="text" class="form-control" min=0 step="any" id="Otros_Impuestos_607" name="Otros_Impuestos_607" value="<?php echo $EditarRegistro607["Otros_Impuestos_607"];?>" required>


    </div>
<?php 
$totalFacturavi607 = + $EditarRegistro607["Monto_Facturado_607"] + $EditarRegistro607["ITBIS_Facturado_607"] + $EditarRegistro607["Monto_Propina_Legal_607"] + $EditarRegistro607["Impuesto_Selectivo_al_Consumo_607"] + $EditarRegistro607["Otros_Impuestos_607"];
 ...
 ?>
    <div class="col-xs-6" style="padding-left: 20px">
            <label>Total Factura </label>
                ...
                <input type="text" class="form-control" id="TotalFacturavi607" name="TotalFacturavi607" placeholder="0000" value="<?php echo $totalFacturavi607;?>" required readonly>
              ...
              <div class="form-group">
                  ...
                  switch ($Tipo_Transaccion_607){ 
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="Descripcion" name="Editar-Descripcion" value="<?php echo $EditarRegistro607["Descripcion_607"];?>">
...
<button type="submit" class="btn btn-warning pull-right">Modificar</button>
         ...
         $EditarRegistro607 = new Controlador607();
          $EditarRegistro607 -> ctrEditar607();
              ...
              $reporte607 = Controlador607::ctrMostrarReporte607($Rnc_Empresa_607, $Orden, $periodoreporte607);
               ...
               foreach ($reporte607 as $key => $value){
                          ...
                          echo '<tr>
                            ...
                            <td>'.$value["Forma_de_Pago_607"].'</td> <td>';
