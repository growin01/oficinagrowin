    ...
    <br>
          ...
          <table class="table table-bordered table-striped dt-responsive tablaComentarios"  width="100%">
            ...
            <tbody>
              ...
              $taidUsuario = "id_Usuario";
              $taNombreUsuario = "Nombre_Usuario";
          ...
          foreach ($mensajes as $key => $value){
              ...
              <td>'.$value["Fechadia"].'</td>';
               ...
               if($value["Estado"] == 1){
                  ...
                  echo' <td><button class="btn btn-warning btn-xs">Enviado</button></td>';
                } 
                else {
                ...
                <td>
                  <div class="btn-group">
              <button class="btn btn-warning btn-xs btnenviados" idComentario="'.$value["id"].'" data-toggle="modal" data-target="#modalverenviado"><i class="glyphicon glyphicon-search"></i></button>
...
<div id="modalverenviado" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="enviados" type="button" class="btn btn-default pull-left">Salir</a>
