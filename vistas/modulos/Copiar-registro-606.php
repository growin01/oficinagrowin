   ...
   <a href="cuadre-itbis" class="btn btn-success"><i class="fa fa-pie-chart" style="padding-right:5px"></i>Cuadre Itbis</a>
    ...
    <button class="btn btn-success" data-toggle="modal" data-target="#modalDescarga606"><i class="fa fa-file-text-o" style="padding-right:5px"></i>Descarga de TXT 606</button>
      <ol class="breadcrumb">
        ...
        <li class="active">Copiar Registro 606</li>
      </ol>
    </section>
...
<br>
                  ...
                  <div class="input-group form-control">
                    ...
                    <input type="text"  class="col-xs-8" id="Nombre_Empresa_606" name="Nombre_Empresa_606" value="<?php echo $EditarRegistro606["Nombre_Empresa_606"];?>" readonly>
                  ...
                  switch ($Tipo_Transaccion_606){ 
                        ...
                        echo '<input type="radio" name="Transaccion_606" id="Personal" value="1" checked>Personal
                          ...
                          ?>
                            ...
                            <input type="text" class="col-xs-6 Fechames" maxlength="6" id="FechaPagomes606" name="FechaPagomes606" value="<?php echo $EditarRegistro606["Fecha_Trans_AnoMes_606"];?>">
                            ...
                            <br>
                            <select type="text" class="form-control" id="agregarBanco" name="Editar-agregarBanco" >
...
';
    ...
    ?>
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="Editar-Descripcion" name="Descripcion" value="<?php echo $EditarRegistro606["Descripcion_606"];?>">
...
<button type="submit" class="btn btn-success pull-right">Copiar y Registar</button>
