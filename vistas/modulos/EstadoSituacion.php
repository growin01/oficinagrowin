           ...
           <div class="form-group">
                  ...
                  if(isset($_GET["Nivel"])){
                   ...
                   ?>
                      ...
                      <button style ="margin-left: 5px" class="btn btn-warning btnEstadoSituacion" id="EstadoSituacion"><i class="glyphicon glyphicon-search"></i>  </button>
        ...
        <div class="box-body">
          ...
          <table class="table table-bordered table-striped dt-responsive tablaTodos" width="80%">
            ...
            <thead>
              ...
              <th style="width:3px; align-content: center;">Genérica</th>
              <th style="width:3px; align-content: center;">Cuenta</th>
                  ...
                  if($value["id_grupo"] == $i){
                   ...
                   $totalPasivo = $MontoGrupo;
                    ...
                    echo '<tr>
                        ...
                        <td></td> 
                        <td></td> 
                        <td style="font-weight:bold; border:1px solid #eee;">PASIVOS</td>
                        <td style="font-weight:bold; border:1px solid #eee; background: #D5D8DC;">'.number_format($MontoGrupo, 2).'</td>
                        <td></td>
                        <td></td>
                        <td></td>
                  ...
                  if($value["id_grupo"] == $i){
                   ...
                   $totalPatrimonio = $MontoGrupo;
                    ...
                    echo '<tr>
                        ...
                        <td></td> 
                        <td></td> 
                        <td style="font-weight:bold; border:1px solid #eee;">PATRIMONIO</td>
                        <td style="font-weight:bold; border:1px solid #eee; background: #D5D8DC;">'.number_format($MontoGrupo , 2).'</td>
                        <td></td>
                        <td></td>
                        <td></td> 
          ...
          if(isset($_GET["Nivel"]) AND $_GET["Nivel"] == 2){
            ...
            for ($i=1; $i <=3 ; $i++) {
              switch ($i) {
                  ...
                  if($value["id_grupo"] == $i){
                   ...
                   $totalActivo = $MontoGrupo;
                    ...
                    echo '<tr>
                        ...
                        <td></td> 
                        <td></td> 
                        <td style="font-weight:bold; border:1px solid #eee; background: #D5D8DC;">ACTIVOS</td>
                        <td style="font-weight:bold; border:1px solid #eee; background: #D5D8DC;">'.number_format($MontoGrupo, 2).'</td>
                        <td></td>
                        <td></td>
                        <td></td>  
                ...
                foreach ($respuesta as $key => $value){
                  ...
                  <td style="font-weight:bold; border:1px solid #eee;">'.number_format($MontoCategoria, 2).'</td>
                  <td></td>
                  <td></td>
                  <td></td> 
                  </tr>';
                  ...
                  if($value["id_grupo"] == $i){
                   ...
                   $totalPasivo = $MontoGrupo;
                    ...
                    echo '<tr>
                        ...
                        <td></td> 
                        <td></td> 
                        <td style="font-weight:bold; border:1px solid #eee; background: #D5D8DC;">PASIVOS</td>
                        <td style="font-weight:bold; border:1px solid #eee; background: #D5D8DC;">'.number_format($MontoGrupo, 2).'</td>
                        <td></td>
                        <td></td> 
                        <td></td> 
            ...
            <td style="font-weight:bold; border:1px solid #eee;">'.number_format($MontoCategoria, 2).'</td>
                  ...
                  if($value["id_grupo"] == $i){
                   ...
                   $MontoGrupo = $sumaGrupoCredito - $sumaGrupoDebito;
                   $totalPatrimonio = $MontoGrupo + $totalEstado; 
                    ...
                    echo '<tr>
                        ...
                        <td style="font-weight:bold; border:1px solid #eee; background: #D5D8DC;">'.number_format($totalPatrimonio, 2).'</td>
                        <td></td>
                        <td></td>
                        <td></td>  
                        </tr>';
