  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="crear-pos" class="btn btn-success"><i class="glyphicon glyphicon-saved" style="padding-right:5px"></i>Crear POS</a>
       <a href="crear-pos-pro" class="btn btn-success"><i class="glyphicon glyphicon-saved" style="padding-right:5px"></i>Crear POS Proforma</a>
...
<?php 
if(isset($_SESSION["imprimirfacturaPOS"])){
  $NCF_FacturaPOS = $_SESSION["NCF_FacturaPOS"];
  $RNCCliente_FacturaPOS = $_SESSION["RNCCliente_FacturaPOS"];
  

  $tabla = "ventas_empresas";

  $datos = array("Rnc_Empresa_Venta" => $_SESSION["RncEmpresaUsuario"],
  "Rnc_Cliente" => $RNCCliente_FacturaPOS,
  "NCF_Factura" => $NCF_FacturaPOS); 

  $ventas = ModeloVentas::MdlValidarVentas($tabla, $datos);
  
}else{
  $_SESSION["imprimirfacturaPOS"] = "";
  $ventas["id"] = "";
...
?>
<input type="hidden"  id="imprimirfacturaPOS" name="imprimirfacturaPOS" value="<?php echo $_SESSION["imprimirfacturaPOS"];?>">
<input type="hidden"  id="id_FacturaPOS" name="id_FacturaPOS" value="<?php echo $ventas["id"];?>">
...
unset($_SESSION["imprimirfacturaPOS"]);
...
<input type="hidden"  id="Impresoraveraccion" name="Impresoraveraccion" value="">
...
<input type="hidden"  id="NombreEmpresaVentas" name="NombreEmpresaVentas" value="<?php echo $_SESSION["NombreEmpresa"];?>">
<input type="hidden"  id="Impresora" name="Impresora" value="<?php echo $_SESSION["Impresora"];?>">

<input type="hidden"  id="DireccionEmpresaVentas" name="DireccionEmpresaVentas" value="<?php echo $_SESSION["DireccionEmpresa"];?>">


<input type="hidden"  id="TelefonoEmpresaVentas" name="TelefonoEmpresaVentas" value="<?php echo $_SESSION["TelefonoEmpresa"];?>">

<input type="hidden"  id="CorreoEmpresaVentas" name="CorreoEmpresaVentas" value="<?php echo $_SESSION["CorreoEmpresa"];?>">
...
<input type="hidden" class="form-control" id="PorDescuentoConf" name="PorDescuentoConf" value="<?php echo $_SESSION["PorDescuentoConf"] ?>">
  ...
  <div class="form-group col-xs-6">
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-addon"><i class="fa fa-key">&nbsp;N° Control:</i></span> 
                      <?php 
...
<input type="hidden" class="form-control" id="Comision_Factura" name="Comision_Factura" value="1" readonly>
...
date_default_timezone_set('America/Santo_Domingo');
          ...
          $subtraerfechaanomes = substr($fecha, 0, 7);
          $subtraerfechaano = substr($subtraerfechaanomes, 0, 4);
          $subtraerfechames = substr($subtraerfechaanomes, -2);
          $Fechaañomes = $subtraerfechaano.$subtraerfechames;
 ...
 ?>
<input type="hidden" class="form-control" maxlength="6" id="Fechafacturaimp" name="Fechafacturaimp" value="<?php echo $fecha;?>" placeholder="Año/Mes Ejemplo 202001" required>
        
   
<input type="hidden" class="form-control" maxlength="6" id="FechaFacturames" name="FechaFacturames" value="<?php if (isset($_SESSION['FechaFacturames'])){ echo $_SESSION['FechaFacturames'];}else{echo $Fechaañomes;}?>" placeholder="Año/Mes Ejemplo 202001" required>
        

<input type="hidden" class="form-control" maxlength="2" id="FechaFacturadia" name="FechaFacturadia"  value="<?php if (isset($_SESSION['FechaFacturadia'])){ echo $_SESSION['FechaFacturadia'];}else{echo $fechadia;}?>" placeholder="Día Ejemplo 01" required autofocus>
...
<?php  
if(isset($_SESSION["NCFFactura"])){
                         
$NCFFactura = $_SESSION["NCFFactura"];

switch ($NCFFactura) {

case 'B01':
echo' <select class="form-control"  id="NCFFactura" name="NCFFactura" required>
...
<input type="text" maxlength="13" class="form-control" id="CodigoNCF" name="CodigoNCF" value = "<?php echo $string;?>" required>
...
<?php 
if(isset($_SESSION["Tipo_Cliente_Factura"])){

  $Tipo_Cliente_Factura = $_SESSION["Tipo_Cliente_Factura"];

    switch ($Tipo_Cliente_Factura) {
      case '1':
      ...
      break;
        ...
        <div class="form-group col-xs-6">
            ...
            <div class="input-group">
              ...
              <input type="text" maxlength="11" class="form-control input-xs" id="RncClienteFactura" name="RncClienteFactura" placeholder="Ingresar Documento" value="<?php if (isset($_SESSION['RncClienteFactura'])){ echo $_SESSION['RncClienteFactura']; } ?>"required>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control input-xs" maxlength="11" id="Nombre_Cliente" name="Nombre_Cliente" placeholder="Nombre Cliente" value="<?php if (isset($_SESSION['Nombre_Cliente'])){ echo $_SESSION['Nombre_Cliente'];}?>" required>
    ...
    <div class="form-group col-xs-6 pull-left">
                    ...
                    <div class="input-group pull-left">
                     ...
                     <div class="input-group form-control pull-left Moneda">
...
<input type="radio" name="Moneda_Factura" id="Moneda_Factura" value="USD" required>$ USD';
   ...
   <div class="form-group col-xs-6 pull-left">
                    ...
                    <div class="input-group pull-left TASA">
...
<div class="col-xs-6">
 <div class="col-xs-4">
    ...
    <div class="form-group col-xs-8">
            ...
            <div class="input-group">
              <span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
 <input type="text" class="form-control" id="nuevoTotalVenta" name="nuevoTotalVenta" total="" placeholder="0000" value="0"required readonly>
  ...
  <hr>
              ...
              <div class="form-group">
                    ...
                    <div class="input-group form-control">
                      <?php 
                      if (isset($_SESSION["nuevoMetodoPago"])) {
                        $nuevoMetodoPago = $_SESSION["nuevoMetodoPago"];

                        switch ($nuevoMetodoPago) {
                          
                          case '01':
                              echo ' <input type="radio" name="nuevoMetodoPago" id="EFECTIVO" value="01" required checked>01-EFECTIVO
                        <br>
                        <input type="radio" name="nuevoMetodoPago" id="CHEQUES_TRANSFERENCIAS_DEPOSITO" value="02" required>02-CHEQUES/TRANSFERENCIAS/DEPOSITO<br>
                        <input type="radio" name="nuevoMetodoPago" id="TARJETA_CREDITO_DEBITO" value="03" required>03-TARJETA CREDITO/DEBITO<br>
                        <input type="radio" class="Dias_Credito" name="nuevoMetodoPago" id="VENTA A CREDITO" value="04" required>04-VENTA A CREDITO<br>
                        ...
                        <br>';
                          break;
                          case '02':
                              echo ' <input type="radio" name="nuevoMetodoPago" id="EFECTIVO" value="01" required>01-EFECTIVO
                        <br>
                        <input type="radio" name="nuevoMetodoPago" id="CHEQUES_TRANSFERENCIAS_DEPOSITO" value="02" required checked>02-CHEQUES/TRANSFERENCIAS/DEPOSITO<br>
                        <input type="radio" name="nuevoMetodoPago" id="TARJETA_CREDITO_DEBITO" value="03" required>03-TARJETA CREDITO/DEBITO<br>
                        <input type="radio" class="Dias_Credito" name="nuevoMetodoPago" id="VENTA A CREDITO" value="04" required>04-VENTA A CREDITO<br>
                        ...
                        <br>
                        <input type="radio" name="nuevoMetodoPago" id="CHEQUES_TRANSFERENCIAS_DEPOSITO" value="02" required>02-CHEQUES/TRANSFERENCIAS/DEPOSITO<br>
                        <input type="radio" name="nuevoMetodoPago" id="TARJETA_CREDITO_DEBITO" value="03" required checked>03-TARJETA CREDITO/DEBITO<br>
                        <input type="radio" class="Dias_Credito" name="nuevoMetodoPago" id="VENTA A CREDITO" value="04" required>04-VENTA A CREDITO<br>
                        ...
                        <input type="radio" name="nuevoMetodoPago" id="CHEQUES_TRANSFERENCIAS_DEPOSITO" value="02" required>02-CHEQUES/TRANSFERENCIAS/DEPOSITO<br>
                        <input type="radio" name="nuevoMetodoPago" id="TARJETA_CREDITO_DEBITO" value="03" required>03-TARJETA CREDITO/DEBITO<br>
                        <input type="radio" class="Dias_Credito" name="nuevoMetodoPago" id="VENTA A CREDITO" value="04" required checked>04-VENTA A CREDITO<br>
...
<button type="submit" id="btnimprimirEPSON" class="btn btn-primary pull-right">Registrar</button>
<?php 
...
unset($_SESSION["Comision_Factura"]);
unset($_SESSION["NCFFactura"]);
unset($_SESSION["Tipo_Cliente_Factura"]);
unset($_SESSION["nuevoMetodoPago"]);
