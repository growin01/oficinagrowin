    ...
    <section class="content">
      ...
      <div class="col-lg-5 col-xs-12">
          ...
          <div class="box box-success">
                ...
                <div class="box" >
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="RncEmpresaMaster" name="RncEmpresaMaster" value="<?php echo $_SESSION["RncEmpresaUsuario"];?>" readonly>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                     ...
                     <div class="input-group form-control">
                        ...
                        <input type="radio" name="Tipo_Empresa" id="fisico" value="Firma-Empresa" required checked readonly>Firma-Empresa
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control"  id="Nombre_Empresa" name="Nombre_Empresa" placeholder="Nombre de la Empresa"  required readonly>
            ...
            <div class="input-group">
              <span class="input-group-addon"><i class="fa fa-user"></i></span>
              <input type="text" class="form-control input-lg" name="nuevoNombre" value="<?php echo $_SESSION["Nombre"]?>" required readonly>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control input-lg" id="nuevoUsuario" name="nuevoUsuario" value="<?php echo $_SESSION["Usuario"]?>" required readonly>
