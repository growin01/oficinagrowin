        ...
        <!--=====================NCF=============================================-->
                 ...
                 <div class="col-xs-12"> 
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control input-NCF" id="Editar-NCF_606" name="Editar-NCF_606" maxlength="13" placeholder="Ingrese NCF" value="<?php echo $compra["NCF_Factura"]?>" required>
                    <input type="hidden" name="NCF_606-anterior" value="<?php echo $compra["NCF_Factura"]?>">
