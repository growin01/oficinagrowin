                ...
                $respuesta = ControladorEmpresas::ctrControlEmpresaIndividual($Rnc_Empresa);
                        ...
                        foreach ($respuesta as $key => $value){
                          ...
                          if($value["TSS_Empresa"] == "1"){
                             echo '<td><button class="btn btn-warning btnTSSind" idcontrolTSS="'.$value["id"].'" estadoTSS="2" FechacontrolTSS="'.$value["Periodo_Empresa"].'">En Proceso</button></td>';
                          }elseif($value["TSS_Empresa"] == "2"){
                             echo '<td><button class="btn btn-success btnTSSind" idcontrolTSS="'.$value["id"].'" estadoTSS="2" FechacontrolTSS="'.$value["Periodo_Empresa"].'">Terminado</button></td>';  
                          }else{
                              echo '<td><button class="btn btn-danger btnTSSind" idcontrolTSS="'.$value["id"].'" estadoTSS="1" FechacontrolTSS="'.$value["Periodo_Empresa"].'">Sin Información</button></td>'; 
                          }


                          if($value["IR3_Empresa"] == "1"){
                             echo '<td><button class="btn btn-warning btnIR3ind" idcontrolIR3="'.$value["id"].'" estadoIR3="2" FechacontrolTSS="'.$value["Periodo_Empresa"].'">En Proceso</button></td>';
                          }elseif($value["IR3_Empresa"] == "2"){
                             echo '<td><button class="btn btn-success btnIR3ind" idcontrolIR3="'.$value["id"].'" estadoIR3="2" FechacontrolTSS="'.$value["Periodo_Empresa"].'">Terminado</button></td>';  
                          }else{
                              echo '<td><button class="btn btn-danger btnIR3ind" idcontrolIR3="'.$value["id"].'" estadoIR3="1" FechacontrolTSS="'.$value["Periodo_Empresa"].'">Sin Información</button></td>'; 
                          }
