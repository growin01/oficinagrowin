...
if($gastosgenerales["EXTRAER_NCF"] == "B11" || $gastosgenerales["EXTRAER_NCF"] == "B13"){

echo'
<input type="text" class="form-control input-NCF" id="Editar-NCF_606" name="Editar-NCF_606" maxlength="13" value='.$gastosgenerales["NCF_Factura"].' required readonly>

<input type="hidden" name="NCF_606-anterior" value='.$gastosgenerales["NCF_Factura"].'  required readonly>';


}else{

echo'  
<input type="text" class="form-control input-NCF" id="Editar-NCF_606" name="Editar-NCF_606" maxlength="13" value='.$gastosgenerales["NCF_Factura"].' required>

<input type="hidden" name="NCF_606-anterior" value='.$gastosgenerales["NCF_Factura"].' required>';
