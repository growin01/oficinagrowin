...
<h1 class="col-xs-4" style="font-size: 30px"><i class="fa fa-file-text-o"></i>
  ...
  <a href="reporte-607" class="btn btn-success"><i class="fa fa-server" style="padding-right:5px"></i>Reporte 607</a>
   ...
   <button title = "Limpiar Formulario 607"class="btn btn-danger btn-xs btnLimpiar607 pull-right"><i class="fa fa-eraser"></i></button>

            </div>

    <?php 
if(isset($_GET["Limpiar607"]) && $_GET["Limpiar607"] == "SI"){
...
<input type="text" class="form-control input-NCFMOD" maxlength="11" id="NCF_Modificado_607" name="NCF_Modificado_607" placeholder="NCF Afectado" value="<?php if (isset($_SESSION['NCF_Modificado_607'])){ echo $_SESSION['NCF_Modificado_607']; } ?>">
 ...
 <div class="form-group col-lg-12">
  ...
  <input class="form-control" type="text"  class="col-xs-8" id="Nombre_Empresa_607" name="Nombre_Empresa_607" placeholder="Nombre del Cliente" value="<?php if (isset($_SESSION['Nombre_Empresa_607'])){ echo $_SESSION['Nombre_Empresa_607']; } ?>" readonly>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" min=0 step="any" id="Monto_Facturado_607" name="Monto_Facturado_607" value="<?php if (isset($_SESSION['Monto_Facturado_607'])){ echo $_SESSION['Monto_Facturado_607']; } ?>" required>
   ...
   <input class="form-control" type="text"  min=0 step="any" id="ITBIS_Facturado_607" name="ITBIS_Facturado_607" value="<?php if (isset($_SESSION['ITBIS_Facturado_607'])){ echo $_SESSION['ITBIS_Facturado_607']; } ?>" required>
  ...
  <input type="text" class="form-control" min=0 step="any" id="Monto_Propina_Legal_607" name="Monto_Propina_Legal_607" value="<?php if (isset($_SESSION['Monto_Propina_Legal_607'])){ echo $_SESSION['Monto_Propina_Legal_607']; } ?>" required>
  ...
  <input type="text" class="form-control" min=0 step="any" id="Impuesto_Selectivo_al_Consumo_607" name="Impuesto_Selectivo_al_Consumo_607" value="<?php if (isset($_SESSION['Impuesto_Selectivo_al_Consumo_607'])){ echo $_SESSION['Impuesto_Selectivo_al_Consumo_607']; } ?>" required>
  ...
  <input type="text" class="form-control" min=0 step="any" id="Otros_Impuestos_607" name="Otros_Impuestos_607" value="<?php if (isset($_SESSION['Otros_Impuestos_607'])){ echo $_SESSION['Otros_Impuestos_607']; } ?>" required>
    ...
    <div class="col-xs-6" style="padding-left: 20px">
            <label>Total Factura </label>
                ...
                <input type="text" class="form-control" id="TotalFacturavi607" name="TotalFacturavi607" placeholder="0000" value="" required readonly>
              ...
              <div class="form-group">
                    ...
                    <div class="input-group form-control Formapago">
                      ...
                      if (isset($_SESSION["Forma_De_Pago_607"])) {
                        $Forma_De_Pago_607 = $_SESSION["Forma_De_Pago_607"];
                        ...
                        <div class="input-group form-control Formapago">
                          ...
                          if (isset($_SESSION["Transaccion_607"])) {
                           ...
                           ?>
                            ...
                            <input type="text" class="col-xs-6 Fecha_Trans_AnoMes" maxlength="6" id="FechaPagomes607" name="FechaPagomes607" placeholder="Año/Mes" value="<?php if (isset($_SESSION["FechaPagomes607"])){ echo $_SESSION["FechaPagomes607"]; } ?>">

                            <input type="text" class="col-xs-6 Fecha_Trans_Dia" id="FechaPagodia607" name="FechaPagodia607" placeholder="Día" value="<?php if (isset($_SESSION["FechaPagodia607"])){ echo $_SESSION["FechaPagodia607"]; } ?>"><br>

                            <label>Referecnia</label><br>
                            <input type="text" class="col-xs-12"  id="Referencia_607" name="Referencia_607" placeholder="Referencia del Pago" value="<?php if (isset($_SESSION["Referencia_607"])){ echo $_SESSION["Referencia_607"]; } ?>">
                            <br>
...
<button type="submit" class="btn btn-primary pull-right">Registrar</button>
          ...
          $crearRegistro607 = new Controlador607();
          $crearRegistro607 -> ctrRegistrar607();
...
if($_SESSION["Contabilidad"] == 1){
  if($value["Modulo"] == "607"){
      ...
      echo'<button class="btn btn-warning btn-xs btnEditar607" id_607="'.$value["id"].'" modulo = "registro-607" data-toggle="modal" data-target="#modalEditar607" ><i class="fa fa-pencil"></i></button>
      <button class="btn btn-primary btn-xs btnCopiar607" id_607="'.$value["id"].'" modulo = "registro-607" data-toggle="modal" data-target="#modalEditar607" ><i class="fa fa-copy"></i></button>
    ...
    <button class="btn btn-warning btn-xs btnEditar607" id_607="'.$value["id"].'" modulo = "registro-607" data-toggle="modal" data-target="#modalEditar607" ><i class="fa fa-pencil"></i></button>
     <button class="btn btn-primary btn-xs btnCopiar607" id_607="'.$value["id"].'" modulo = "registro-607" data-toggle="modal" data-target="#modalEditar607" ><i class="fa fa-copy"></i></button>
    <button class="btn btn-danger btn-xs btnEliminar607" id_607="'.$value["id"].'"><i class="fa fa-times"></i></button>
    <button class="btn btn-primary btn-xs btnRetener607" id_607="'.$value["id"].'" Rnc_Empresa_607="'.$_SESSION["RncEmpresaUsuario"].'"data-toggle="modal" data-target="#modalRetener607" ><i class="fa fa-university"></i></button></div>';
    }
  }
