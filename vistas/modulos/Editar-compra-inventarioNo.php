  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 class="col-xs-5" style="font-size: 30px"><i class="glyphicon glyphicon-book"></i>
        COMPRA DE INVENTARIO PROFORMA
...
<input type="hidden" class="form-control" id="NAsientoRet" name="NAsientoRet" value="<?php echo $compra["NAsientoRET"];?>" required>
  ...
  <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
       ...
       <input type="text" class="form-control" maxlength="6" id="FechaFacturames_606" name="FechaFacturames_606" value="<?php echo $compra["FechaAnoMes"]?>" placeholder="Año/Mes Ejemplo 202001"  required autofocus>
...
<div style="padding-left: 0px" class="form-group col-xs-4">
  ...
  <div class="input-group">
 <input type="text" class="form-control" maxlength="2" id="FechaFacturadia_606" name="FechaFacturadia_606"  value="<?php echo $compra["FechaDia"]?>" placeholder="Día Ejemplo 01" required autofocus>
 </div>  
...
<div class="col-xs-12"></div>
                 ...
                 <div class="col-xs-12"> 
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control input-NCF" id="CodigoCompra" name="CodigoCompra" value="<?php echo $compra["CodigoCompra"]?>" required readonly>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control input-NCF" id="Editar-NCF_606" name="Editar-NCF_606" maxlength="13" placeholder="Ingrese NCF" value="<?php echo $compra["NCF_Factura"]?>" required readonly>
                    <input type="hidden" name="NCF_606-anterior" value="<?php echo $compra["NCF_Factura"]?>" readonly>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control input-NCFMOD" maxlength="11" id="NCF_Modificado_606" name="NCF_Modificado_606" placeholder="NCF MODIFICADO" value="">
        ...
        <div class="form-group col-xs-12 pull-right" style="background-color: #BEEDB6">
         ...
         <div class="form-group col-xs-4">
            ...
            <div class="input-group">
              ...
              <input type="text" maxlength="11" class="form-control input-RNC" id="Editar-RncSuplidorFactura" name="Editar-RncSuplidorFactura" value="<?php echo $Suplidor["Documento_Suplidor"]?>" required>
              <input type="hidden" name="RncSuplidor-anterior" value="<?php echo $Suplidor["Documento_Suplidor"]?>">
        ...
        $codigo = ControladorDiario::ctrCodigoAsientoDiario($Rnc_Empresa_Diario, $tipocod);
          ...
          echo '<div class="form-group col-xs-8">
                  ...
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="Descripcion" name="Descripcion" placeholder="Descripcion" value="'.$compra["Referencia"].'" required>
              ...
              <div class="col-xs-3">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="NAsiento" name="NAsiento" value="'.$compra["NAsiento"].'" readonly> 
    ...
    <div class="box-footer">
          <button type="submit" class="btn btn-primary pull-right">Registrar</button>
           ...
           <?php 
            ...
            $comprasinventario -> ctrEditarcomprasinventario();
...
<input type="hidden" class="form-control " id="ModuloProducto" name="ModuloProducto" value="crear-compra-inventarioNo" readonly>
