<div class="content-wrapper">
  <section class="content-header">
     <h1 class="col-xs-4" style="font-size: 30px"><i class="fa fa-shopping-cart"></i>
        COPIAR COMPRAS GENERALES
      </h1>
...
$NCFCompra = $gastosgenerales["EXTRAER_NCF"];
...
$NCFFactura = $gastosgenerales["EXTRAER_NCF"];

$respuesta = ControladorCorrelativos::ctrCorrelativosFac($RncEmpresaVentas, $NCFFactura);

$numero = $respuesta["NCF_Cons"]+1;

switch ($gastosgenerales["EXTRAER_NCF"]) {
  
  case 'B11':
  $CodigoNCF = str_pad($numero, 8, "0", STR_PAD_LEFT);
  $NCF_606 = $NCFFactura.$CodigoNCF;
    echo'<input type="text" maxlength="11" class="form-control input-NCF" id="CodigoNCFCompra" name="CodigoNCFCompra" value='.$CodigoNCF.' required readonly>';
  break;
  case 'B13':
  $CodigoNCF = str_pad($numero, 8, "0", STR_PAD_LEFT);
  $NCF_606 = $NCFFactura.$CodigoNCF;
  ...
  break;
  case 'E41':
  $CodigoNCF = str_pad($numero, 10, "0", STR_PAD_LEFT);
  $NCF_606 = $NCFFactura.$CodigoNCF;
    echo'<input type="text" maxlength="13" class="form-control input-NCF" id="CodigoNCFCompra" name="CodigoNCFCompra" value='.$CodigoNCF.' required readonly>';
  break;
  case 'E43':
  $CodigoNCF = str_pad($numero, 10, "0", STR_PAD_LEFT);
  $NCF_606 = $NCFFactura.$CodigoNCF;
  ...
  break;
  default:
  $ExtraerNCF = substr($gastosgenerales["EXTRAER_NCF"], 0, 1);
  if($ExtraerNCF == "B"){
     echo'<input type="text" maxlength="11" class="form-control input-NCF" id="CodigoNCFCompra" name="CodigoNCFCompra" required>';
