...
<div style="padding-right: 0px"  class="form-group col-lg-6">
  ...
  <div class="input-group">
    ...
    <input type="text" class="form-control Fechames" maxlength="6" id="FechaFacturames_606" name="FechaFacturames_606" value="<?php if (isset($_SESSION['FechaFacturames606'])){ echo $_SESSION['FechaFacturames606'];}?>" placeholder="Año/Mes Ejemplo 202001" required autofocus>
...
<div style="padding-left: 0px" class="form-group col-lg-6">
  ...
  <div class="input-group">
   <input type="text" class="form-control Fechadia" maxlength="2" id="FechaFacturadia_606" name="FechaFacturadia_606" value="<?php if (isset($_SESSION['FechaFacturadia_606'])){ echo $_SESSION['FechaFacturadia_606'];}?>" placeholder="Día Ejemplo 01" required>
...
echo'<input type="hidden" id="ModuloBanco" name="ModuloBanco" value="Desactivado" required readonly>
        ...
        <input type="hidden" class="form-control col-xs-12" id="agregarBanco" name="agregarBanco" value="" required>';
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="Descripcion" name="Descripcion" placeholder="Descripcion" value="<?php echo $EditarRegistro606["Descripcion_606"];?>"  required>
