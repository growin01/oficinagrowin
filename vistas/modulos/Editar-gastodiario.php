               ...
               <?php 
                ...
                <div class="box">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                     ...
                     <label>Año/Mes</label>
                      <input type="text" class="Fechames" maxlength="6" id="FechaFacturames_606" name="FechaFacturames_606"  value="<?php echo $EditarRegistro606["Fecha_AnoMes_606"];?>" required autofocus>

                     
                      <label>Dìa</label>
                      <input type="text" class="Fechadia" maxlength="2" id="FechaFacturadia_606" name="FechaFacturadia_606" value="<?php echo $EditarRegistro606["Fecha_Dia_606"];?>" required>
                  ...
                  <div class="input-group form-control">
                    ...
                    <input type="text"  class="col-xs-8" id="Nombre_Empresa_606" name="Nombre_Empresa_606" value="<?php echo $EditarRegistro606["Nombre_Empresa_606"];?>" readonly required>
                 ...
                 <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control input-NCF" maxlength="11" id="NCF_606" name="NCF_606" value="<?php echo $EditarRegistro606["NCF_606"];?>" required>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control input-NCFMOD" maxlength="11" id="NCF_Modificado_606" name="NCF_Modificado_606" value="<?php echo $EditarRegistro606["NCF_Modificado_606"];?>">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-xs-6 right" style="padding-right:0px">
                        ...
                        <input type="number"  min=0 step="any" id="Montototalbienes" name="Montototalbienes" value="<?php echo $EditarRegistro606["Monto_Bienes_606"];?>" required>
                     ...
                     <div class="col-xs-6 left" style="padding-right:0px">
                        ...
                        <input type="number"  min=0 step="any" id="Montototalservicios" name="Montototalservicios" value="<?php echo $EditarRegistro606["Monto_Servicios_606"];?>" required>
                    ...
                    <div class="col-xs-6 right" style="padding-right:0px">
                      ...
                      <br>
                        ...
                        <input type="number"  min=0 step="any" id="MontoITBIS" name="MontoITBIS" value="<?php echo $EditarRegistro606["ITBIS_Factura_606"];?>" required>
                     ...
                     <div class="col-xs-6" style="padding-right:0px">
                      ...
                      <br>
                        ...
                        <input type="number"  min=0 step="any" id="Propinalegal" name="Propinalegal" value="<?php echo $EditarRegistro606["Monto_Propina_606"];?>" required>
                    ...
                    <div class="col-xs-6" style="padding-right:0px">
                      ...
                      <br>
                        ...
                        <input type="number"  min=0 step="any" id="ImpuestoSelectivo" name="ImpuestoSelectivo" value="<?php echo $EditarRegistro606["Impuestos_Selectivo_606"];?>" required>
                     ...
                     <div class="col-xs-6" style="padding-right:0px">
                      ...
                      <br>
                        ...
                        <input type="number"  min=0 step="any" id="OtrosImpuestos" name="OtrosImpuestos" value="<?php echo $EditarRegistro606["Otro_Impuesto_606"];?>" required>
...
<!--*****************CHECKBOX DE PORCENTAJE********************** -->
              ...
              <div class="form-group">
                  ...
                  switch ($Tipo_Transaccion_606){ 
                        ...
                        case "1":
                        echo '<input type="radio" name="Transccion" id="Personal" value="1" checked>Personal
                            
                            <input type="radio" name="Transccion" id="Empresarial" value="2">Empresarial
                             <br>';
                            
                            break;

                            case "2":
                            echo '<input type="radio" name="Transccion" id="Personal" value="1">Personal
                            
                            <input type="radio" name="Transccion" id="Empresarial" value="2" checked>Empresarial
                             <br>';
                               break;
...
<input type="text" class="col-xs-2 Fechames" maxlength="6" id="FechaPagomes606" name="FechaPagomes606" value="'.$EditarRegistro606["Fecha_Trans_AnoMes_606"].'" required>

<input type="text" class="col-xs-2 Fechadia" id="FechaPagodia606" name="FechaPagodia606" value="'.$EditarRegistro606["Fecha_Trans_Dia_606"].'" required><br>
<input type="text" class="col-xs-3" maxlength="6" id="Referencia" name="Referencia" value="'.$EditarRegistro606["Referencia_606"].'" required>
...
echo'<input type="hidden" id="ModuloBanco" name="ModuloBanco" value="Desactivado" required readonly>
        <input type="hidden" class="col-xs-2 Fecha_Trans_AnoMes" id="FechaPagomes606" name="FechaPagomes606" value="'.$EditarRegistro606["Fecha_Trans_AnoMes_606"].'" required readonly>
        <input type="hidden" class="col-xs-2 Fecha_Trans_Dia" id="FechaPagodia606" name="FechaPagodia606" value="'.$EditarRegistro606["Fecha_Trans_Dia_606"].'" required readonly><br>
...
<div class="col-xs-12 left">
  <div class="form-group">
    <div class="input-group">
        ...
        <input type="text" class="form-control" id="Descripcion" name="Descripcion" value="<?php echo $EditarRegistro606["Descripcion_606"];?>">
  ...
  $Rnc_Factura = $EditarRegistro606["Rnc_Factura_606"];
  $NCF = $EditarRegistro606["NCF_606"];
...
$respuesta = ControladorDiario::ctrMostrarGastoDiarioEditar($id_registro, $Rnc_Empresa_LD, $Rnc_Factura, $NCF, $Extraer);
                ...
                <input type="hidden" class="col-xs-12" id="listaCuentas" name="listaCuentas">
                      ...
                      <label><h3>N° de Asiento A Modificar</h3></label>
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="NAsiento" name="NAsiento" value="<?php echo $NAsiento;?>" readonly>
                    ...
                    if($Empresa["Banco"] == 1){
                      ...
                      <label><h3>Estatus Conciliación</h3></label>
                        <div class="input-group col-xs-4">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-edit"></i></span>

                      <input type="text" class="form-control btn-primary" value="Tránsito">
                   ...
                   ';
                      ...
                      <input type="text" class="form-control btn-success" value="Conciliado">
          ...
          <?php 
            ...
            $Editarlibrodiario -> ctrEditargastodiario();
           ...
           <table class="display nowrap table table-bordered table-striped tabladiario606">
               ...
               foreach ($reporte606 as $key => $value){
                echo '<tr>
                            ...
                            <td>
                              <div class="btn-group">
                                <button class="btn btn-warning btnRetener606" id_606="'.$value["id"].'" Rnc_Empresa_606="'.$_SESSION["RncEmpresaUsuario"].'"data-toggle="modal" data-target="#modalRetener606" ><i class="fa fa-university"></i></button>
                  ...
                  case '2':
                    ...
                    $generica = ControladorContabilidad::ctrplandecuenta($Rnc_Empresa_Cuentas, $grupo, $categorias);
                      ...
                      foreach ($subgenerica  as $key => $subgene){
                        ...
                        <td><button class="btn btn-primary agregarCuenta recuperarCuenta" idgrupo="'.$i.'" idcategoria="'.$value["id_categoria"].'" idgenerica="'.$gene["id_generica"].'" idcuenta="'.$subgene["id_subgenerica"].'" NombreCuenta="'.$subgene["Nombre_subCuenta"].'" >+</button></td>
