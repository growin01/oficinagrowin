...
<div class="content-wrapper">
  <section class="content-header">
    <h1 class="col-xs-6" style="font-size: 30px"><i class="fa fa-shopping-cart"></i>
       COMPRAS GENERALES PROFORMA
    </h1>
  ...
  <section class="content">
    <div class="row">
       ...
       <div class="col-lg-7" style="padding-right: 2px">
...
if($respuesta == false){
  ...
  echo'<button class="btn btn-warning pull-right btn-xs"  data-toggle="modal" data-target="#modalCorrelativoNoFiscalRET"><i class="fa fa-pencil"></i></button>';
          ...
          $Empresa = ControladorEmpresas::ctrEmpresas($Rnc_Empresa, $Rnc_Empresa_Master, $Orden);
               ...
               if($respuesta == false){
                   echo'<button class="btn btn-warning pull-right"  data-toggle="modal" data-target="#modalCorrelativoNoFiscalNO"><i class="fa fa-pencil"></i></button>
                  ';
...
<div style="padding-right: 0px"  class="form-group col-xs-4">
  ...
  <div class="input-group">
    ...
    <input type="text" class="form-control Fechames" maxlength="6" id="FechaFacturames_606" name="FechaFacturames_606" value="<?php if (isset($_SESSION['FechaFacturames_606'])){ echo $_SESSION['FechaFacturames_606'];}?>" placeholder="Año/Mes Ejemplo 202001" required autofocus>
                 ...
                 <div class="col-xs-4" style="padding-right:0px">
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-addon"><i class="fa fa-key"></i></span> 
                       ...
                       <select class="form-control"  id="NCFCompraNo" name="NCFCompraNo" required>
...
$numero = $respuesta["NCF_Cons"]+1;
$CodigoNCFNo = str_pad($numero, 8, "0", STR_PAD_LEFT);
$NCF_606 = "CP1".$CodigoNCFNo;

               
              
?>

<input type="text" maxlength="11" class="form-control" id="CodigoNCFNo" name="CodigoNCFNo" value="<?php echo $CodigoNCFNo?>"required readonly>

<input type="hidden" class="form-control input-NCF" id="NCF_606" name="NCF_606" maxlength="13" placeholder="Ingrese NCF" value="<?php if (isset($_SESSION['NCF_606'])){ echo $_SESSION['NCF_606']; }else{ echo $NCF_606; } ?>" required>

<input type="hidden" class="form-control input-NCFMOD" maxlength="11" id="NCF_Modificado_606" name="NCF_Modificado_606" placeholder="NCF MODIFICADO" value="<?php if (isset($_SESSION['NCF_Modificado_606'])){ echo $_SESSION['NCF_Modificado_606']; } ?>">
...
echo '<input type="text" class="form-control input-xs" id="Nombre_Suplidor" name="Nombre_Suplidor" value='.$_SESSION["Nombre_Suplidor"].' required>';

}else{
echo'<input type="text" class="form-control input-xs" id="Nombre_Suplidor" name="Nombre_Suplidor" placeholder="Nombre Suplidor" required>';
...
echo '<input type="text" class="form-control" id="Descripcion" name="Descripcion" placeholder="Descripcion" value='.$_SESSION["Descripcion"].' required>';

}else{
echo'<input type="text" class="form-control" id="Descripcion" name="Descripcion" placeholder="Descripcion" value=""  required>';
     ...
     <div class="col-xs-6">
      ...
      <div class="col-xs-6">
        ...
        <div class="form-group col-xs-2" style="padding-right: 0px">
          ...
          <input  class="form-control" type="number" min="0" id="PORITBIS" name="PORITBIS" value="0" required>
         </div>
      </div>
...
unset($_SESSION["propinalegal"]);
            ...
            $gastogenerales -> ctrcomprasgeneralesNO();
...
<div id="modalCorrelativoNoFiscal" class="modal fade" role="dialog">
  ...
  ******************************************************* -->
  <!-- Modal -->
<div id="modalCorrelativoNoFiscalNO" class="modal fade" role="dialog">
             ...
             <div class="form-group col-xs-6">
               <label>Tipo de NCF</label>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control input-NCF" id="Tipo_NCF" name="Tipo_NCF" maxlength="3" Value="CP1" readonly>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control input-lg" id="ModuloSuplidor" name="ModuloSuplidor" value="crear-compra-gastosgeneralesNo" readonly>
