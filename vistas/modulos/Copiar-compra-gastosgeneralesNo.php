...
<div class="content-wrapper">
  <section class="content-header">
     <h1 class="col-xs-5" style="font-size: 30px"><i class="fa fa-shopping-cart"></i>
        COPIAR COMPRAS GENERALES PROFORMA
        ...
        <div class="form-group col-xs-4">
          ...
          <div class="form-group col-xs-4">
            ...
            <div class="input-group">
              ...
              <input type="text" maxlength="11" class="form-control input-xs" id="RncSuplidorFactura" name="RncSuplidorFactura"  value="<?php echo $Suplidor["Documento_Suplidor"]?>" required>
...
<input type="text" class="col-xs-2 Fechames" maxlength="6" id="FechaPagomes606" name="FechaPagomes606" required>

<input type="text" class="col-xs-2 Fechadia" id="FechaPagodia606" name="FechaPagodia606"  required><br>
<input type="text" class="col-xs-3" maxlength="6" id="Referencia" name="Referencia"  required>
...
echo'<input type="hidden" id="ModuloBanco" name="ModuloBanco" value="Desactivado" required readonly>
        <input type="hidden" class="col-xs-2 Fecha_Trans_AnoMes" id="FechaPagomes606" name="FechaPagomes606"  required readonly>
        <input type="hidden" class="col-xs-2 Fecha_Trans_Dia" id="FechaPagodia606" name="FechaPagodia606"  required readonly><br>
