...
<div style="padding-right: 0px"  class="form-group col-lg-6">
  ...
  <div class="input-group">
    ...
    <input type="text" class="form-control Fechames_607" maxlength="6" id="Editar-FechaFacturames_607" name="Editar-FechaFacturames_607" value="<?php echo $EditarRegistro607["Fecha_comprobante_AnoMes_607"];?>"  required autofocus>
...
<div style="padding-left: 0px" class="form-group col-lg-6">
  ...
  <div class="input-group">
     ...
     <input type="text" class="form-control Fechadia_607" maxlength="2" id="Editar-FechaFacturadia_607" name="Editar-FechaFacturadia_607" value="<?php echo $EditarRegistro607["Fecha_Comprobante_Dia_607"];?>" required>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-xs-4 right" style="padding-right:0px">
                        ...
                        <input type="number" class="form-control" min=0 step="any" id="Editar-Monto_Facturado_607" name="Editar-Monto_Facturado_607" value="<?php echo $EditarRegistro607["Monto_Facturado_607"];?>" required>
                     ...
                     <div class="col-xs-4" style="padding-right:0px">
                        ...
                        <input type="number"  class="form-control" min=0 step="any" id="Editar-ITBIS_Facturado_607" name="Editar-ITBIS_Facturado_607" value="<?php echo $EditarRegistro607["ITBIS_Facturado_607"];?>" required>
                      ...
                      <div class="col-xs-4 left" style="padding-right:0px">
                        ...
                        <input type="number" class="form-control" min=0 step="any" id="Editar-Otros_Impuestos_607" name="Editar-Otros_Impuestos_607" value="<?php echo $EditarRegistro607["Otros_Impuestos_607"];?>" required>
...
echo'</select>
  ...
  <input type="hidden" class="form-control col-xs-12" id="Editar-agregarBanco" name="Editar-agregarBanco" value="" required>';
                      ...
                      <input type="text" class="form-control" id="Editar-Descripcion" name="Editar-Descripcion" value="<?php echo $EditarRegistro607["Descripcion_607"];?>">
          ...
          $Editaringresodiario -> ctrEditaringresodiario(); 
