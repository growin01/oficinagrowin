  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="crear-ventas" class="btn btn-success"><i class="glyphicon glyphicon-saved" style="padding-right:5px"></i>Crear Factura</a>
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
             ...
             if(isset($_GET["NCotizacion"])){
                  ...
                  $TotalImpuesto = $Cotizacion["Impuesto"];
                  $Total = $Cotizacion["Total"];

                  $Impuesto = $Cotizacion["Impuesto"] * 100 / $Cotizacion["Neto"];

                  $porcentaje = round($Impuesto, 0, PHP_ROUND_HALF_UP);
...
<input type="hidden"  id="idCotizaccion" name="idCotizaccion" value="<?php echo $idCotizacion;?>">
 <input type="hidden" style ="margin-left: 5px" maxlength="11" id="NCotizacion" name="NCotizacion" value="<?php echo $Cotizacion["NCF_Cotizacion"];?>">
...
if(isset($_GET["NCotizacion"])){
    if($Cotizacion["id_Vendedor"] == ""){
      ...
      echo '<select type="text" class="form-control" id="idVendedor" name="idVendedor" required>
        ...
        /***************FACTURA CON COMISION Y VENDEDOR*******************************/
...
<div style="padding-right: 0px"  class="form-group col-xs-4">
  ...
  <div class="input-group">
    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
       ...
       <input type="text" class="form-control" maxlength="6" id="FechaFacturames" name="FechaFacturames" value="<?php if (isset($_SESSION['FechaFacturames'])){ echo $_SESSION['FechaFacturames'];}?>" required>
                    ...
                    <div class="input-group">
                      ...
                      <select type="text" class="form-control" id="agregarCliente" name="agregarCliente" placeholder="Agregar Cliente">
                        ...
                        <?php 
                          ...
                          echo '<option value="'.$Cotizacion["id_Cliente"].'">'.$Cotizacion["Nombre_Cliente"].'</option>';
        ...
        <div class="form-group col-xs-6">
            ...
            <div class="input-group">
              ...
              <input type="text" maxlength="11" class="form-control input-xs" id="RncClienteFactura" name="RncClienteFactura" placeholder="Ingresar Documento" value="<?php echo $clienteDocumento?>"required>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control input-xs" maxlength="11" id="Nombre_Cliente" name="Nombre_Cliente" placeholder="Nombre Cliente" value="<?php echo $clienteNombre?>" required>
          ...
          <!--*****************cierra input de EMAIL************************* -->
           ...
           <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
              <input type="text" class="form-control input-xs"  maxlength="150" id="Observaciones" name="Observaciones" value="<?php echo  $Cotizacion["Observaciones"]?>" placeholder=" Obrservaciones de Factura">
     ...
     <div class="form-group col-xs-6">
            ...
            <div class="input-group">
              <span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
               ...
               <input type="text" class="form-control" id="nuevoPrecioNetovi" name="nuevoPrecioNetovi" placeholder="0000" value="<?php echo $Cotizacion["Neto"]?>" required readonly>

                <input type="hidden" class="form-control" id="nuevoPrecioNeto" name="nuevoPrecioNeto" placeholder="0000" value="<?php echo $Cotizacion["Neto"]?>" required readonly>
...
<div class="col-xs-6">
 ...
 <div class="form-group col-xs-2" style="padding-right: 0px">
          ...
          echo'<input  class="form-control" type="number" min="0" id="nuevoporDescuento" name="nuevoporDescuento" value="'.$Cotizacion["Pordescuento"].'" required>';
           }else{

            echo'<input  class="form-control" type="number" min="0" id="nuevoporDescuento" name="nuevoporDescuento" value="'.$Cotizacion["Pordescuento"].'" required readonly>';
   ...
   <div class="form-group col-xs-4" style="padding-left: 0px">
          ...
          <input type="text" class="form-control" id="Descuentovi" name="Descuentovi" value="<?php echo $Cotizacion["Descuento"]?>" required readonly>

          <input type="hidden" name="Descuento" id="Descuento" value="<?php echo $Cotizacion["Descuento"]?>" required readonly>
...
<div class="col-xs-6">
 ...
 <div class="form-group col-xs-2" style="padding-right: 0px">
          ...
          <input  class="form-control" type="number" min="0" id="nuevoImpuestoVenta" name="nuevoImpuestoVenta" value="<?php echo $Cotizacion["Porimpuesto"]?>" required>
  ...
  <input type="text" class="form-control" id="nuevoPrecioImpuestovi" name="nuevoPrecioImpuestovi" placeholder="0000" value="<?php echo $Cotizacion["Impuesto"]?>" required readonly>
  

  <input type="hidden" class="form-control" id="nuevoPrecioImpuesto" name="nuevoPrecioImpuesto" placeholder="0000" value="<?php echo $Cotizacion["Impuesto"]?>" required readonly>
 ...
 <div class="col-xs-6">
    ...
    <div class="form-group col-xs-6">
            ...
            <div class="input-group">
              <span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
 <input type="text" class="form-control" id="nuevoTotalVenta" name="nuevoTotalVenta" total="" placeholder="0000" value="<?php echo $Cotizacion["Total"]?>" required readonly>

<input type="hidden" name="totalVenta" id="totalVenta"value="<?php echo $Cotizacion["Total"]?>" >
