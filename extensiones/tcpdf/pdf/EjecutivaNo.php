...
$bloque1 = <<<EOF
	...
	<tr>
		...
		<tr>
			...
			<td style="width:540px;font-weight: bold; background-color:$faccolor1; text-align:center">DATOS DEL COMPROBANTE</td>

		</tr>
		<tr>
			<td style="font-weight: bold;width:80px">N°:</td>
			<td style="width:180px">$NCF_Factura</td>
			<td style="font-weight: bold;width:100px">Valido Hasta:</td>
		...
		<tr>
			<td style="font-weight: bold;width:80px">Fecha:</td>
			<td style="width:180px">$Fecha</td>
			<td style="font-weight: bold;width:100px">Forma de Pago:</td>
...
$bloque2 = <<<EOF
		...
		<tr>
			<td style="font-weight: bold;background-color:$faccolor3; width:540px; text-align:center">OBSERVACIONES DEL COMPROBANTE</td>
		</tr>
...
<tr>
       ...
       <tr>
         ...
         <tr>
            ...
            <td style="font-weight: bold; width:100px; text-align:right">Desc. $PorDescuento %:</td>
