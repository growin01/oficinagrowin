...
$respuestaCXP = ControladorCXP::ctrMostarCXP($Rnc_Empresa_CXP);
...
<br>
    ...
    <tr>
     ...
     <tr>
        ...
        <td style="font-weight: bold; border: 1px solid #666; color:#333; background-color:$faccolor2; width:110px; text-align:center">Total Pagado</td>
