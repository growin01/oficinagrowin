...
$PeriodoCXP = $this->PeriodoCXP;

$Suplidor = $this->Suplidor;


$respuestaCXP = ControladorCXP::ctrMostarCXPPeriodoSuplidor($Rnc_Empresa_CXP, $PeriodoCXP, $Suplidor);
...
$MostrarEstadoCXP = "Pagado";
$Titulos ="Cuentas Por Pagar ";
$Periodo ="Todo";

$TotalResumen = "Total Pagado";
...
$bloque1 = <<<EOF
    ...
    <tr>
        ...
        <td style="width:$anchoresto; font-size:15px; text-align:center">INFORME FINANCIERO<br>$Nombre<br>$Titulos<br>Periodo $PeriodoCXP</td>
    </tr>
        ...
        <tr>
           ...
           <tr>
                ...
                <td style="width:70px; text-align:center">PERIODO: </td>
                 <td style="width:70px; text-align:center">$PeriodoCXP </td>
...
if($value["Moneda"] == "DOP"){ 
    ...
    $tipo = "FACTURA";
        ...
        $datos = array("Rnc_Empresa_cxp" =>$value["Rnc_Empresa_cxp"],
          ...
          if(!$Npago){
                ...
                $MontoPagado = 0;
                 ...
                 foreach ($Npago as $key => $n) {
                    if($n["FechaAnoMes"] = $PeriodoCXP || $n["FechaAnoMes"] < $PeriodoCXP)
