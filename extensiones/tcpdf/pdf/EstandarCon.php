...
$bloque1 = <<<EOF
	...
	<tr>
			...
			<td style="width:187px; font-size:10px; text-align:right">NO VALIDA PARA CRÉDITO FISCAL
</td>
		...
		<tr>
			...
			<td style="width:270px; background-color:$faccolor1; text-align:center">DATOS FACTURA PROFORMA</td>
...
$bloque2 = <<<EOF
		...
		<tr>
			<td style="background-color:$faccolor3; width:540px; text-align:center">OBSERVACIONES DE FACTURA PROFORMA</td>
		</tr>
