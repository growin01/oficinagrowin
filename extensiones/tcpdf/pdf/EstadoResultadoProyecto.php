...
$id = "id";
$valorid = $this->Proyecto;

$respuestapro = ModeloProyecto::mdlModalEditarProyectos($tabla, $id, $valorid);
$nombrepro = $respuestapro["NombreProyecto"];
$CodigoProyecto = $respuestapro["CodigoProyecto"];
...
<table style="font-size:10px; padding:3px 3px">
    <tr>
            ...
            <td style="width:$anchoresto; font-size:12px; text-align:center">$Nombre<br>Estado de Resultado del Proyecto<br> $nombrepro - $CodigoProyecto
            <br>Período Desde $mosfechamesDesde Hasta $mosfechamesHasta<br></td>
...
$estadoresultadoproyecto = new estadoresultado();
$estadoresultadoproyecto -> FechaDesde = $_GET["FechaDesde"];
$estadoresultadoproyecto -> FechaHasta = $_GET["FechaHasta"];
$estadoresultadoproyecto -> RncEmpresa = $_GET["RncEmpresa"];
$estadoresultadoproyecto -> Proyecto = $_GET["codproyecto"];
$estadoresultadoproyecto -> ImpresionEstado();
