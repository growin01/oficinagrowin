...
$bloque1 = <<<EOF
    ...
    <tr>        
            <td style="width:80px; font-size:10px; text-align:right"></td>
            ...
            <td style="width:187px; font-size:10px; text-align:right">FACTURA DE CRÉDITO FISCAL</td>
        ...
        <tr>
         <td style="width:70px">Teléfono:</td>
            <td style="width:250px">$Telefono</td>
            

       
            <td style="width:70px">NCF:</td>
        ...
        <tr>
            ...
            <td style="width:70px">Forma de Pago:</td>
        ...
        <tr>
            <td style="background-color:white; width:320px"> </td>
             <td style="width:70px">Valida hasta:</td>
...
$bloque5 = <<<EOF
    ...
    <table style="font-size:10px; padding: 5px 10px;">
        ...
        <tr>
            ...
            <td style="border: 1px solid #666; background-color:white; width:100px; text-align:center">Sub-Total $Moneda $:</td>
        ...
        <tr>
            ...
            <td style="border: 1px solid #666; background-color:white; width:100px; text-align:center">Total $Moneda $:</td>
        ...
        <tr>
            ...
            <td style="font-size:8px; font-weight: bold; border-top-color:#050404; border-top-style:solid; border-top-width:1px; background-color:white; width:100px; text-align:right">$TextoTasa</td>

            <td style="font-weight: bold; border-top-color:#050404; border-top-style:solid; border-top-width:1px; background-color:white; width:100px; text-align:right"></td>
        ...
        <tr>
            ...
            <td style="font-size:8px;background-color:white; width:100px; text-align:center">ORIGINAL:</td>

            <td style="font-size:8px;background-color:white; width:100px; text-align:center">CLIENTE</td>
         ...
         <tr>
            <td style="background-color:white; width:$restosello; text-align:center"></td>
              ...
              <td style="width:$ancho"><img src="../../../$Sello" width="$ancho" height="$largo"></td>
            <td style="background-color:white; width:$restosello; text-align:center"></td>

            <td style="font-size:8px;background-color:white; width:100px; text-align:center">COPIA:</td>

            <td style="font-size:8px;background-color:white; width:100px; text-align:center">EMPRESA</td>
