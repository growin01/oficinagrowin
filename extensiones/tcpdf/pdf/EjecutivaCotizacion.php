...
$bloque1 = <<<EOF
    ...
    <tr>        
            ...
            <td style="width:150px; font-size:9px; text-align:right">N° de Cotización de Control:</td>
            <td style="width:100px; font-size:9px; text-align:left">$Codigo</td>
            <td style="width:187px; font-size:9px; text-align:right">COTIZACIÓN</td>
        ...
        <tr>
            ...
            <td style="width:250px">31-12-2022</td>
...
$pdf->writeHtml($bloque1, false, false, false, false, '');
    ...
    <tr>        
            ...
            <td style="width:150px; font-size:9px; text-align:right">N° de Cotización de Control:</td>
            <td style="width:100px; font-size:9px; text-align:left">$Codigo</td>
            <td style="width:180px; font-size:9px; text-align:right">COTIZACIÓN</td>
